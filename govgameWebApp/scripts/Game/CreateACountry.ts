...
const flags = ["france", "germany", "india", "russia", "uk", "usa", "italy"];
function randomiseFlag() {
    var flag = flags[Math.floor(Math.random() * flags.length)];

    (document.getElementById("flagImg") as HTMLImageElement).src = "/images/flags/" + flag + ".png";
    currentFlag = flag;
}
...
function formSubmitted() {
    var form = document.getElementById("country-form") as HTMLFormElement;
